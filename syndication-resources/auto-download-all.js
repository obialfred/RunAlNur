// AUTO DOWNLOAD ALL 114 FILES - NO PROMPTS
// Paste this in browser console while logged into Kajabi
...
// Download function using fetch + blob (no prompts!)
...
async function downloadAll() {
  console.log(`🚀 Starting download of ${downloadUrls.length} files...`);
  console.log('Files will auto-save to your Downloads folder.\n');
  ...
  for (let i = 0; i < downloadUrls.length; i++) {
    ...
    console.log(`[${i+1}/${downloadUrls.length}] ${name}`);
  ...
  console.log(`\n✅ COMPLETE! Downloaded: ${success}, Failed: ${failed}`);
}
